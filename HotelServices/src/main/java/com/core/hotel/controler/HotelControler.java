...
public class HotelControler {
	...
	public ResponseEntity<List<Hotel>> searchHotelDetail(@RequestParam(required = false)  Map<String,String> searchParam) {
		...
		if(searchParam!=null) { 
			...
			if( hotelName!=null && !hotelName.equals("null"))
				return ResponseEntity.ok(hotelService.getHotelDetailsByName(hotelName));
